...
public class LogParserTest {
	...
	@Test
	public void should_convert_log_line_to_domain_object() throws ParseException {
		DnsLogLine dnsLogLine = sut.dnsLogLineFromLogLine(LOG_LINE);

		assertEquals(QUERY_TYPE, dnsLogLine.getQueryType());
		assertEquals(QUERY_DOMAIN, dnsLogLine.getQueryDomain());
		assertEquals(QUERY_TARGET, dnsLogLine.getQueryTarget());
	}
}